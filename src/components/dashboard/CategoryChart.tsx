...
const data = [
  { name: "Electronics", value: 35, color: "hsl(24, 95%, 53%)" },
  { name: "Wearables", value: 25, color: "hsl(217, 91%, 60%)" },
  { name: "Audio", value: 20, color: "hsl(199, 89%, 48%)" },
  { name: "Accessories", value: 15, color: "hsl(222, 47%, 31%)" },
  { name: "Office", value: 5, color: "hsl(199, 89%, 65%)" },
];
