...
export function ProductTableFormm() {
  ...
  const [query, setQuery] = useState("SELECT TOP (10) * FROM Formm_trans Where [Date] = '2026-02-11'");
  ...
  return (
    <div className="bg-card rounded-lg border border-border shadow-card opacity-0 animate-fade-in" style={{ animationDelay: "300ms" }}>
      <div className="p-6 border-b border-border">
        <h3 className="text-lg font-semibold text-foreground">Top Products Formming </h3>
