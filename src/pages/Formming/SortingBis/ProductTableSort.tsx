...
interface ProductTableSortProps {
  startDate?: Date;
  endDate?: Date;
}

export function ProductTableSort({
  startDate,
  endDate,
  ...
  const exportToCsv = () => {
    ...
    link.href = url;
    link.download = `sorting-bisque-scrap-analysis_${format(new Date(), "yyyyMMdd_HHmmss")}.csv`;
...
export default ProductTableSort;