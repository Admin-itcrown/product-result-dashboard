...
import { ProductTableClay } from "./ProductTableClay";
import { ProductChartClay } from "./ProductChartClay";
import { CategoryChartClay } from "./CategoryChartClay";
...
const Clay1 = () => {
  ...
  const { statsData, loading } = useFetchClayStats(startDate, endDate);
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <div className="lg:col-span-2">
              <ProductChartClay startDate={startDate} endDate={endDate} />
            </div>

            <CategoryChartClay startDate={startDate} endDate={endDate} />
          </div>

          {/* TABLE */}
          <ProductTableClay startDate={startDate} endDate={endDate} />
