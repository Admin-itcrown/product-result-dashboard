...
================================ */
export function useFetchGlazeStats(
  ...
  WHERE [Date] BETWEEN '${formattedStart}' AND '${formattedEnd}' AND [OP] = 10 AND [Type] = 'BACKFLSH'
  GROUP BY [Line]
  ORDER BY [Line]
`;
        ...
        const solidQuery = `
          ...
          AND [Date] BETWEEN '${formattedStart}' AND '${formattedEnd}'AND [OP] = 10 AND [Type] = 'BACKFLSH'
          ORDER BY [Line]
        `;
