...
import { useFetchSortWWStats } from "./StatCardWW";
import { StatCardWW } from "./StatCardWW";
import { ProductChartWW } from "./ProductChartWW";
import { CategoryChartWW } from "./CategoryChartWW";
import { ProductTableWW} from "./ProductTableWW";
...
const SortingWWTotal = () => {
  ...
  const { statsData, loading } = useFetchSortWWStats(startDate, endDate);
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <CategoryChartWW startDate={startDate} endDate={endDate} />
          </div>
