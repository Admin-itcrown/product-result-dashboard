...
import { useFetchStampStats } from "./StatCardStamp";
import { StatCardStamp } from "./StatCardStamp";
import { ProductChartStamp } from "./ProductChartStamp";
import { CategoryChartStamp } from "./CategoryChartStamp";
import { ProductTableStamp } from "./ProductTableStamp";
...
const Stamp1 = () => {
  ...
  const { statsData, loading } = useFetchStampStats(startDate, endDate);
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <CategoryChartStamp startDate={startDate} endDate={endDate} />
          </div>
